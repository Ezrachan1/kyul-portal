...
export const contentSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      t('home.chain.eyebrow', 'Value chain · eyebrow', 'The Kyul value chain'),
      t('group.valueChain.title', 'Value chain · title', group.valueChain.title),
      ta('group.valueChain.lede', 'Value chain · lede', group.valueChain.lede),
  ...
  },
  {
    ...
    fields: [
      ...
      t('companies.chain.eyebrow', 'Value chain · eyebrow', 'How they work together'),
