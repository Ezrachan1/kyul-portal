...
export const subsidiaries = [
  ...
  // ─────────────────────────────────────────── VENTURES
  {
    ...
    projects: [
      { name: 'County HQ: Design & PM', client: 'Uasin Gishu County', location: 'Eldoret', value: 'Undisclosed', year: '2023–24', scope: 'Architecture, structures & project management', sector: 'Buildings', status: 'Completed' },
      { name: 'Irrigation Scheme Feasibility', client: 'County + Donor', location: 'Rift Valley', value: 'Undisclosed', year: '2024', scope: 'Feasibility, hydrology & cost plan', sector: 'Water', status: 'Completed' },
      { name: 'Agro-processing Master Plan', client: 'Kyul Projects SPV', location: 'Western', value: 'Undisclosed', year: '2025', scope: 'Master-plan & M&E concept design', sector: 'Manufacturing', status: 'In progress' },
    ],
    stats: [
  ...
  // ─────────────────────────────────────────── ENTERPRISES
  {
    ...
    services: [
      ...
      { name: 'Import & Export', icon: 'lucide:ship', text: 'Specialist equipment and commodity import and export with customs handling.' },
    ...
    projects: [
      ...
      { name: 'Plant Hire Pool', client: 'Kyul Engineering', location: 'Rift Valley', value: 'Undisclosed', year: 'Ongoing', scope: 'Earthmoving & compaction fleet', sector: 'Plant', status: 'Active' },
      { name: 'Agri-commodity Aggregation', client: 'Regional buyers', location: 'Western & Nyanza', value: 'Undisclosed', year: '2025', scope: 'Grain aggregation & distribution', sector: 'Agribusiness', status: 'Active' },
    ],
    stats: [
  ...
  // ─────────────────────────────────────────── PROJECTS
  {
    ...
    projects: [
      ...
      { name: 'Industrial Minerals Concession', client: 'JV with partner', location: 'Rift Valley', value: 'Undisclosed', year: '2025', scope: 'Licensed, mercury-free quarry SPV', sector: 'Mining', status: 'Licensing' },
  ...
  // ─────────────────────────────────────────── HOLDINGS
  {
    ...
    projects: [
      { name: 'Kyul Engineering Limited', client: 'Equity holding', location: 'Construction', value: 'Held', year: 'N/A', scope: 'Civil & structural contractor', sector: 'Operating Co', status: 'Held' },
      { name: 'Kyul Ventures Limited', client: 'Equity holding', location: 'Consulting', value: 'Held', year: 'N/A', scope: 'Design & project management', sector: 'Operating Co', status: 'Held' },
      { name: 'Kyul Enterprises Limited', client: 'Equity holding', location: 'Trade', value: 'Held', year: 'N/A', scope: 'Trade & logistics', sector: 'Operating Co', status: 'Held' },
      { name: 'Kyul Projects Limited', client: 'Equity holding', location: 'Development', value: 'Held', year: 'N/A', scope: 'Project origination & SPVs', sector: 'Operating Co', status: 'Held' },
      { name: 'Kyul Investment Limited', client: 'Equity holding', location: 'Asset mgmt', value: 'Held', year: 'N/A', scope: 'Investment & asset management', sector: 'Operating Co', status: 'Held' },
    ],
    stats: [
